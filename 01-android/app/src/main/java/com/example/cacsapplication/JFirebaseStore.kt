...
import com.example.cacsapplication.JCitiesDto
import com.example.cacsapplication.R
...
class JFirebaseStore : AppCompatActivity() {
    var query: Query? = null
    val arreglo: ArrayList<JCitiesDto> = arrayListOf()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_jfirebase_store)
    ...
    fun eliminarRegistro(){
        ...
        referenciaEjemploEstudiante.get().addOnSuccessListener {
            for (estudiante in it) {
                estudiante.reference.delete()
            }
        }
    ...
    fun crearDatosEjemplo(){
        ...
        referenciaEjemploEstudiante
            ...
            .addOnCompleteListener { Toast.makeText(this.baseContext, "Exito quemado", Toast.LENGTH_SHORT) }
            .addOnFailureListener { Toast.makeText(this.baseContext, "Fracaso quemado", Toast.LENGTH_SHORT) }

        // Con identificador generado en Date.time
        referenciaEjemploEstudiante
            .document(identificador.toString())
            .set(datosEstudiante) // actualiza o crea
            .addOnCompleteListener {Toast.makeText(this.baseContext, "Exito generado", Toast.LENGTH_SHORT) }
            .addOnFailureListener { Toast.makeText(this.baseContext, "Fracaso generado", Toast.LENGTH_SHORT) }

        // Sin identificador
        referenciaEjemploEstudiante
            .add(datosEstudiante) // crea
            .addOnCompleteListener { Toast.makeText(this.baseContext, "Exito sin id", Toast.LENGTH_SHORT) }
            .addOnFailureListener { Toast.makeText(this.baseContext, "Fracaso sin id", Toast.LENGTH_SHORT) }
